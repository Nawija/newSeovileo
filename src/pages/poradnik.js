...
const Poradnik = () => (
    <Layout>
        ...
        <div className="flex items-center flex-wrap justify-center text-white text-sm mx-auto max-w-screen md:text-base text-center ">
            <Link
                className="px-2 py-1 m-2 bg-gradient-to-br from-amber-500 to-orange-400 rounded-md"
                to="#seo"
            >
                SEO
            </Link>
            ...
            <div class="container mx-auto flex pt-8 pb-12 px-8 md:flex-row flex-col items-center justify-between">
                <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-8 md:mb-0 items-center text-center">
                    ...
                    <p class="mb-4 leading-relaxed">
                        ...
                        widoczna w wynikach wyszukiwania, co przekłada się na
                        wyższą pozycję strony w wynikach wyszukiwania. Celem SEO
                        jest zwiększenie ruchu na stronie poprzez poprawienie
            ...
            <div class="container mx-auto flex pt-8 pb-12 px-8 md:flex-row flex-col items-center justify-between">
                <div class="md:order-1 lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-end md:text-right mb-8 md:mb-0 items-center text-center">
                    ...
                    <p class="mb-4 leading-relaxed">
                        ...
                        jest dostępna dla użytkowników internetu. Hosting jest
                        niezbędny do funkcjonowania strony internetowej,
                        ponieważ bez tej usługi strona nie będzie dostępna dla
                        użytkowników.
                    </p>
                </div>
                <StaticImage
            ...
            <div class="container mx-auto flex pt-8 pb-12 px-8 md:flex-row flex-col items-center justify-between">
                <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-8 md:mb-0 items-center text-center">
                    ...
                    <p class="mb-4 leading-relaxed">
                        ...
                        Domena składa się z nazwy i rozszerzenia, np. "nazwa.pl"
                        Rejestracja domeny jest pierwszym krokiem do utworzenia
                        własnej strony internetowej, ponieważ bez niej nie można
                        zarejestrować adresu IP serwera, na którym będzie
                        znajdowała się strona internetowa. Domeny są
                        rejestrowane przez różne firmy, zwane rejestratorami
                        domen.
                    </p>
                </div>
                <StaticImage
            ...
            <div class="container mx-auto flex pt-8 pb-12 px-8 md:flex-row flex-col items-center justify-between">
                <div class="md:order-1 lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-end md:text-right mb-8 md:mb-0 items-center text-center">
                    ...
                    <p class="mb-4 leading-relaxed">
                        ...
                        informacje na jednej stronie. Wszystkie treści, takie
                        jak tekst, zdjęcia, filmy, formularze kontaktowe itp.
                        znajdują się na jednej stronie i są dostępne po
                        przewinięciu strony. Ta forma strony jest często
                        stosowana w celach promocyjnych, jako wizytówka firmy
            ...
            <div class="container mx-auto flex pt-8 pb-12 px-8 md:flex-row flex-col items-center justify-between">
                <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-8 md:mb-0 items-center text-center">
                    ...
                    <p class="mb-4 leading-relaxed">
                        ...
                        wielu podstron. Taka strona internetowa może mieć kilka
                        lub kilkanaście podstron, które przedstawiają różne
                        informacje dotyczące danej tematyki. Strony multi page
                        są często stosowane przez firmy, które chcą przedstawić
                        szczegółowe informacje dotyczące swoich produktów lub
                        usług, albo które mają bogatą treść do przedstawienia
                        swoim użytkownikom.
                    </p>
                </div>
                <StaticImage
            ...
            <div class="container mx-auto flex pt-8 pb-12 px-8 md:flex-row flex-col items-center justify-between">
                <div class="md:order-1 lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-end md:text-right mb-8 md:mb-0 items-center text-center">
                    ...
                    <p class="mb-4 leading-relaxed">
                        ...
                        na których jest wyświetlana. Responsywna strona
                        automatycznie dostosowuje swoją szerokość, układ i
                        typografię do rozmiaru ekranu, dzięki czemu zapewnia
                        dobre doświadczenie użytkownika na każdym urządzeniu,
                        czy to komputerze, tablecie czy smartfonie. Dzięki
                        responsywności strona internetowa jest czytelna i łatwa
                        do nawigacji, bez potrzeby tworzenia oddzielnych wersji
            ...
            <div class="container mx-auto flex pt-8 pb-12 px-8 md:flex-row flex-col items-center justify-between">
                <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-8 md:mb-0 items-center text-center">
                    ...
                    <p class="mb-4 leading-relaxed">
                        ...
                        obszar, który obejmuje zarówno aspekty estetyczne, jak i
                        funkcjonalne. Celem designu jest stworzenie rozwiązania,
                        które jest nie tylko atrakcyjne wizualnie, ale również
                        przydatne i użyteczne. Design może dotyczyć różnych
                        dziedzin, takich jak architektura, grafika, moda,
