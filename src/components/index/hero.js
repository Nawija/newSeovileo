...
const Hero = () => (
    <section className="relative w-full h-screen max-h-[90rem] flex flex-col items-center justify-center text-base mx-auto max-w-[2200px] md:text-lg xl:items-start xl:px-0 px-3 sm:px-8 py-2 md:py-24 -z-10">
        <video
            className="fixed max-w-[2200px] mx-auto h-full w-full shadow-2xl object-cover object-center -z-10"
            src={heroVideo}
            type="video/mp4"
            autoPlay
            loop
        ...
        <div class="fixed bg-amber-300 max-w-[2200px] mx-auto mix-blend-multiply h-full w-full -z-10"></div>
