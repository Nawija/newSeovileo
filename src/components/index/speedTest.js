...
const SpeedTest = () => (
    <section className="relative w-full flex flex-col md:flex-row max-w-screen-2xl items-center justify-center mx-auto text-base md:text-lg px-3 sm:px-8 pt-8 md:pt-24">
        <div className="w-full lg:w-1/2 lg:ml-12 px-2 lg:px-1 md:px-12 sm:px-8 py-2 md:py-12 bg-white rounded-full">
            <h5 className=" text-sm sm:text-base lg:text-lg tracking-widest text-green-500 drop-shadow-lg techGatsbyAnim">TECHNOLOGIA GATSBY</h5>
        ...
        <div className="relative w-full lg:w-[80%] px-2 md:px-12 sm:px-8 py-2 md:py-12">
            <img className=" w-full h-full" src={speedTest} alt="test wydajności i szybkości" />
            <ArrowsSVG />
        </div>
    </section>
);
