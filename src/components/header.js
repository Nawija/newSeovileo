    ...
    return (
        ...
        >
            <div
                className={
                    navbar
                        ? "absolute transition-colors duration-500 w-full bg-black/90"
                        : "absolute transition-colors duration-200 w-full"
                }
            >
                <nav
                    className={
                ...
                >
                    <Link
                        to="/"
                        className="flex items-center gap-2.5 text-2xl text-main"
                        aria-label="logo"
                    >
                        <svg
