    ...
    <header className="sticky top-0 z-50 shadow-lg">
      <nav className=" bg-black/90">
        <div className="globalWrapper flex py-2 md:py-4 justify-between w-full px-7">
          <Link
            to="/"
            className="flex items-center gap-2.5 text-2xl font-[Righteous] text-white"
            aria-label="logo"
          >
          ...
          >
            <li className="m-6 lg:m-0">
              <Link
                ...
                to="/"
                className=" text-gray-500 hover:text-amber-600 active:text-amber-500 text-base lg:text-lg font-semibold transition duration-200 p-2"
              >
                Home
              </Link>
            </li>
