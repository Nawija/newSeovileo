...
// navbar
//                         ? "absolute px-4 py-4 md:py-6 flex items-center justify-between w-full text-black transition-colors duration-300 bg-black/90"
//                         : "absolute px-4 py-4 md:py-6 flex items-center justify-between w-full text-black transition-colors duration-300"
    ...
    return (
        <header
            ...
            "
        >
           <div className={navbar ?'absolute transition-colors duration-500 w-full bg-black/90' : 'absolute transition-colors duration-200 w-full'}>
           <nav
                className={
                    showMenu
            ...
            >
                <Link
                    to="/"
                    className="flex items-center gap-2.5 text-2xl font-serif text-main"
                    aria-label="logo"
                >
                    <svg
                ...
                <ul
                    className={
                        showMenu
                            ? "absolute top-full left-0 py-8 flex flex-col text-main text-center w-full bg-black/90 opacity-100 transition duration-300 -translate-y-0 -z-10"
                            : "absolute top-full left-0 py-8 flex flex-col md:opacity-100 md:static md:flex-row md:top-0 md:translate-y-0 md:py-0 text-main text-center w-full opacity-0 -translate-y-full transition duration-100 -z-10 md:z-10 md:ml-8"
                    }
                >
                    <Link
